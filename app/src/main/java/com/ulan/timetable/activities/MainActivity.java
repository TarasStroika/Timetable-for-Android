...
import com.ulan.timetable.utils.LocaleHelper;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String locale = sPref.getString("LOCALE", "ru");
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.schoolwebsitemenu:
                openUrlInChromeCustomTab(getApplicationContext(), "");
                return true;
            case R.id.exams:
            ...
            case R.id.language_en:
                ed.putString("LOCALE", "en");
                ed.apply();
                drawer.closeDrawer(GravityCompat.START);
                recreate();
                return true;
            case R.id.language_ua:
                ed.putString("LOCALE", "uk");
                ed.apply();
                drawer.closeDrawer(GravityCompat.START);
                recreate();
                return true;
